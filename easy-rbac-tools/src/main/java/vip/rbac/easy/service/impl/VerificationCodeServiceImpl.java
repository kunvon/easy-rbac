...
import vip.rbac.easy.repository.VerificationCodeRepository;
...
public class VerificationCodeServiceImpl implements VerificationCodeService {
    ...
    public EmailVo sendEmail(VerificationCode code) {
        ...
        if(verificationCode == null){
            ...
            emailVo = new EmailVo(Arrays.asList(code.getValue()),"easy-rbac后台管理系统",content);
        ...
        // 存在就再次发送原来的验证码
            ...
            emailVo = new EmailVo(Arrays.asList(verificationCode.getValue()),"easy-rbac后台管理系统",content);
        }
        return emailVo;
    }
