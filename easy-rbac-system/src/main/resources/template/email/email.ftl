...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <div style="list-style: none;
			...
			font-size: 14px;
            color: #555;">
            <p style="line-height: 12px;">Github：<a hover="color: #DA251D;" style="color: #999;" href="https://github.com/elunez/easy-rbac" target="_blank">https://github.com/elunez/easy-rbac</a></p>
        </div>
